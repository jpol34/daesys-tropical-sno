...
<section class="specials-section" aria-labelledby="specials-heading">
	<div class="container">
		<h2 id="specials-heading" class="section-title text-center">Sweet Deals</h2>
		...
		<div class="specials-grid">
			...
			<div class="special-card giveaways">
				...
				<p>
					Follow us on social media for exclusive giveaways, raffles and seasonal treats throughout
					the year!
				</p>
			...
			<div class="special-card popsicle">
				...
				<p class="popsicle-details">
					Every Wednesday we feature special popsicle flavors. Stop by or give us a call to see
