...
<div class="filters">
	<select id="status-filter" class="form-select filter-select" bind:value={filterStatus}>
		...
		<option value="contacted"
			>Contacted ({requests.filter((r) => r.status === 'contacted').length})</option
		>
		<option value="confirmed"
			>Confirmed ({requests.filter((r) => r.status === 'confirmed').length})</option
		>
		<option value="completed"
			>Completed ({requests.filter((r) => r.status === 'completed').length})</option
		>
	</select>
</div>
			...
			<div class="details-card">
				...
				<div class="details-section">
					...
					<select
						...
						onchange={(e) =>
							updateStatus(selectedRequest!.id, (e.target as HTMLSelectElement).value)}
						disabled={isUpdating}
					>
				...
				<div class="details-section">
					...
					<div class="notes-actions">
						...
						<button class="btn btn-delete" onclick={deleteRequest} disabled={isUpdating}
							>🗑️ Delete</button
						>
